...
class _MainGridViewState extends State<MainGridView> {
  ...
  Widget _gridChild(Widget mainWidget, int pos,
    ...
    return DragTarget(
      ...
      onWillAccept: (data) {
        if (!isFromArrangeP) {
          return widget.onWillAccept!(int.parse(data.toString()), pos);
        }
      ...
      onAccept: (data) {
        if (isFromArrangeP) {
          ...
          widget.onReorder!(int.parse(data.toString()), pos);
        }
      },
    );
  }
      ...
      children: [
        NotificationListener<OverscrollIndicatorNotification>(
          ...
          child: GridView.builder(
            ...
            gridDelegate: widget.headerGridDelegate!,
      ...
      children: [
        ...
        !_isDragStart
            ...
            : Align(
                ...
                child: DragTarget(
                  builder:
                      (context, List<Object?> candidateData, rejectedData) =>
                          Container(
